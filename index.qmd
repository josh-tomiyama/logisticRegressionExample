...
For each point in our data set, we will substitute the observed optimal markup strategy with the optimal markup and check the change in sales and revenue. Any

NOTE TO SELF: Hypothetical impact is evidently producing less revenue overall from simulation. Either simulation is flawed or the optimization is flawed.
